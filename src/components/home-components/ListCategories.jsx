  ...
  return (
    <section className={classes.categories}>
      ...
      <menu className={classes.menu}>
        <Link to="/shop" className={`${classes.iphone} ${classes.hover}`}>
          <img src="./img/product_1.png" alt="iphone" width="100%" />
        </Link>
        <Link to="/shop" className={`${classes.mac} ${classes.hover}`}>
          <img src="./img/product_2.png" alt="mac" width="100%" />
        </Link>
        <Link to="/shop" className={`${classes.ipad} ${classes.hover}`}>
          <img src="./img/product_3.png" alt="ipad" width="100%" />
        </Link>
        <Link to="/shop" className={`${classes.watch} ${classes.hover}`}>
          <img src="./img/product_4.png" alt="watch" width="100%" />
        </Link>
        <Link to="/shop" className={`${classes.airpods} ${classes.hover}`}>
